...
if (version != currentversion) {
    MsgBox, 51, Update Check, A new version of Soe's Macro is avalable.`n`nCurrent Version: %currentversion%`nLastest Version: %version%`n`nVisit download page?
    ifMsgBox, Yes
    {
        run, https://github.com/Cweamy/Mighty-Omega-Macro
    }
}
MsgBox, To pause the macro press K. To stop the macro, press L
if (A_ScreenDPI != 96) { ;; checking scale and layout
    MsgBox,	16,Soe's Macro, Your Scale `& layout settings need to be on 100`%
...
main:
{
    ...
    Gui, Show , h300 w700, Soe's Macro
    WinSet, Region, 0-0 h300 w700 R15-15,Soe's Macro
}
Return
;; sub main
StartTread:
    ...
    if (TS = "" or TL = "" or TE = "" or TD = "" or TA = "") {
        MsgBox,,Soe's Macro,You have incomplete information.
        ExitApp
    }
...
StartSS:
    ...
    if (SSP = "Custom") {
        if (SST = "Karate") { ;Karate|Capoeira|Muay Thai|Advance Brawl|Boxing 
            InputBox, path1, Soe's Macro,Karate 1st Custom Walk Distance (Default: 960ms),, 400, 130
            if (ErrorLevel = 1) {
                msgbox,,Soe's Macro,Set to default
                path1 = 960
            }
            InputBox, path2, Soe's Macro,Karate 2nd Custom Walk Distance (Default: 660ms),, 400, 130
            if (ErrorLevel = 1) {
                msgbox,,Soe's Macro,Set to default
                path2 = 660
            }
        ...
        if (SST = "Capoeira") {
            InputBox, path1, Soe's Macro,Capoeira 1st Custom Walk Distance (Default: 1300ms),, 400, 130
            if (ErrorLevel = 1) {
                msgbox,,Soe's Macro,Set to default
                path1 = 1300
            }
        ...
        if (SST = "Muay Thai") {
            InputBox, path1, Soe's Macro,Muay Thai 1st Custom Walk Distance (Default: 1100ms),, 400, 130
            if (ErrorLevel = 1) {
                msgbox,,Soe's Macro,Set to default
                path1 = 1100
            }
        ...
        if (SST = "Advance Brawl") {
            InputBox, path1, Soe's Macro,Advance Brawl 1st Custom Walk Distance (Default: 1800ms),, 400, 130
            if (ErrorLevel = 1) {
                msgbox,,Soe's Macro,Set to default
                path1 = 1800
            }
        ...
        if (SST = "Boxing") {
            InputBox, path1, Soe's Macro,Boxing 1st Custom Walk Distance (Default: 820ms),, 400, 130
            if (ErrorLevel = 1) {
                msgbox,,Soe's Macro,Set to default
                path1 = 820
            }
            InputBox, path2, Soe's Macro,Boxing 2nd Custom Walk Distance (Default: 580ms),, 400, 130
            if (ErrorLevel = 1) {
                msgbox,,Soe's Macro,Set to default
                path2 = 580
            }
...
DiscordSend(m,p) {
    ...
    postdata={"username":"Soe's Macro","content":"%p% %m%"}
    Return postdata
}
sendsc(keyspe) {
...
LoadMainGui:
    Gui, -Caption
    Gui, +AlwaysOnTop
    Gui, Add, Text, x30 y8, Soe's Macro
...
SubmitWebhook:
    ...
    if (test = 200) {
        ...
        WinHttpReq.SetRequestHeader("Content-Type", "application/json")
        UserID:="<@" UserID ">"
        WinHttpReq.Send(DiscordSend("Webhook successfully set up. Thank you " UserID " for using Soe's Macro.",UserID))
        Msgbox, 4, Soe's Macro, Did you receive the ping?
        ifMsgBox no
        {
            Reload
            ExitApp
        ...
        MsgBox, 16, Soe's Macro, Invalid link
        ExitApp
    } else if (test = 0) {
        MsgBox, 16, Soe's Macro, Timed out
        ExitApp
    }
    goto, main
Return
...
Check:
    if WinExist("Ahk_exe RobloxPlayerBeta.exe") {
        ...
        MsgBox,,Soe's Macro,Roblox not active,3
        ExitApp
    } 
Return
WaitTreadmill:
